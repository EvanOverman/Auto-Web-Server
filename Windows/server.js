...
app.listen(7440812, console.log('Server listening on port 7440812'));const path = require('path');
const express = require('express');
app = express();
...
app.listen(80, console.log('Server listening on port 80'));const path = require('path');
const express = require('express');
app = express();
